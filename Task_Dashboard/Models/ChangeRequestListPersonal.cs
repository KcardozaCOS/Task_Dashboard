...
{
    public partial class ChangeRequestListPersonal
    {
        ...
        public Guid? VotingMethodId { get; set; }
        ...
        public int RelatedIncidentsCount { get; set; }
        public int RelatedProblemsCount { get; set; }
